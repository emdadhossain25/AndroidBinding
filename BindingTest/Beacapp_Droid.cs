...
namespace BindingTest
{
    class Beacapp_Droid
    {
        ...
        public class EventUpdateListener : Java.Lang.Object, Com.Beacapp.IUpdateEventsListener
        {
            ...
            public Becapp_Droid beacappInterfaceImpl;
        ...
        public class Becapp_Droid : IBeacapp

        {
            ...
            public BeacappResponceCode InitializeBeacapp(string requestToken, string secretKey)
            {
                ...
                try
                {
                    manager = Com.Beacapp.JBCPManager.GetManager(Android.App.Application.Context, requestToken, secretKey, null);
                ...
                {
                    Android.Util.Log.Info("info", e.ToString());
